...
body{background:#0e0e0e;color:#c9c9c9;font-family:'Inter',sans-serif;font-size:15px;line-height:1.75;}
...
.hero{background:linear-gradient(180deg,#141414 0%,#0e0e0e 100%);border-bottom:1px solid rgba(245,196,0,.1);padding:64px 0 46px;}
.ep-num{font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#F5C400;margin-bottom:14px;}
h1{font-family:'Bebas Neue',sans-serif;font-size:clamp(34px,5vw,54px);color:#fff;letter-spacing:1px;line-height:1.05;margin-bottom:14px;}
...
h2{font-family:'Bebas Neue',sans-serif;font-size:34px;color:#fff;letter-spacing:1px;margin-bottom:18px;}
...
footer{padding:40px 0 60px;text-align:center;font-size:11px;color:#444;background:#0a0a0a;}
@media(max-width:640px){section{padding:40px 0;}.m3-card{grid-template-columns:1fr;gap:6px;}.bigquote p{font-size:19px;}}
`;
...
export function buildShowNotesHtml(
  ...
  const guestLinksHtml = [
    links.website ? '<a href="' + esc(links.website) + '">Website</a>' : '',
...
<div class="hero">
  <div class="wrap">
    ...
    <div class="listen-row">
      <a href="https://podcasts.apple.com/us/podcast/dave-lukas-the-misfit-entrepreneur-breakthrough/id1145889006" class="listen-btn alt">Apple Podcasts</a>
      <a href="https://open.spotify.com/show/2DAf0Yt9HedZSqoIBCliik" class="listen-btn alt">Spotify</a>
      <a href="https://www.youtube.com/@misfitentrepreneur" class="listen-btn alt">YouTube</a>
    </div>
  </div>
</div>
